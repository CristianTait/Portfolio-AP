...
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexperiencia){      
        ...
        Experiencia experiencia = new Experiencia(dtoexperiencia.getTituloE(), dtoexperiencia.getFechaE(), dtoexperiencia.getNombreE(), dtoexperiencia.getDescripcionE());
    ...
    /*
    @PostMapping("/upload")
    public ResponseEntity<?> uploadFile(@RequestParam("imageE") MultipartFile file) {
    String fileName = Paths.get(file.getOriginalFilename()).getFileName().toString();
    java.nio.file.Path uploadPath = Paths.get("src/main/resources/static/assets/img");
    try {
